...
public class WebAddresses
{
    ...
    Address quadro = new Address();
    quadro.street = fin.nextLine();
    quadro.city = fin.nextLine();
    quadro.state = fin.next();
    quadro.zip = fin.nextInt();
    fin.skip("\n");
    ...
    System.out.println(quadro.street + ", " + quadro.city + ", " + quadro.state + "  " + quadro.zip);
