...
public class DoWhileSwimming
{
    public static void main( String[] args ) throws Exception
    {
        ...
        swimTime = 0;
        // While loop checks if the condition is true before executing any code
        // Gallant is smart and checks the water before diving in
        // Pre-Test
        ...
        swimTime = 0;
        // Do-While loops however executes the code at least once before checking if condition is true
        // Goofus dives in head first only to realize the condition is false
        // Post-Test
        do
        {
